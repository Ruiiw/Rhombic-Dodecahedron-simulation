...
def Send_Link(name, pos, size, rpy,objectType):
    ...
    if filetype == SDF_FILETYPE:
        ...
        link = LINK_URDF(name,pos,size, rpy,objectType)
...
def Send_RD(name="default",pos=[0,0,0],size=[1,1,1], rpy=[0,0,0]):
    Send_Link(name,pos,size,rpy,"RD")
